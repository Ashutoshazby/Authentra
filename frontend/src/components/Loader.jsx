function Loader({ message = "Analyzing your document..." }) {
  return (
    <div className="glass flex flex-col items-center justify-center gap-4 rounded-3xl border border-slate-800 px-8 py-12 text-center shadow-glow">
      <div className="relative flex h-16 w-16 items-center justify-center">
        ...
        <span className="h-4 w-4 rounded-full bg-aqua" />
      </div>
      <div>
